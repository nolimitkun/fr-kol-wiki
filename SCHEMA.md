...
- 默认写给关心法国、但不熟悉法国行政黑话的普通中文读者，不写公文、研报或会议纪要腔。
- 多用短句和主动句。能写“他觉得政府管得太多”，就不写“他对国家监管的过度介入提出质疑”。
- 先说人话版结论，再解释制度和术语；必要的专业词保留，但第一次出现时顺手解释。
- 保留发言人的个人风格：谁爱用比喻、谁喜欢报数字、谁总在攻击对手、谁从亲身经历出发，都要让读者看得出来。
- 可以转述现场的火药味、笑点和打断，但不替发言人加戏，不把编辑判断伪装成原话。
- 不逐句硬译法语语序，不滥用“主张、强调、指出、认为、表示”。交替使用“他的意思是”“她的账是这么算的”“他把问题归到……”等自然表达。
- 小标题尽量回答问题或呈现冲突，例如“钱从哪来？”“减负，还是拆社保？”；避免连续使用抽象名词。
- 白话不等于失真。数字、否定、条件、时间范围和不确定性必须保留，观点与事实仍要严格分开。
